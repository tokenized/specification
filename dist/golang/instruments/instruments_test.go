...
func TestEmptyDeserialize(t *testing.T) {
	...
	instrumentMembership, err := DeserializeV1([]byte(CodeMembership), nil)
	if err != nil {
	...
	instrumentCurrency, err := DeserializeV1([]byte(CodeCurrency), nil)
	if err != nil {
	...
	instrumentShareCommon, err := DeserializeV1([]byte(CodeShareCommon), nil)
	if err != nil {
	...
	instrumentBondFixedRate, err := DeserializeV1([]byte(CodeBondFixedRate), nil)
	if err != nil {
	...
	instrumentCoupon, err := DeserializeV1([]byte(CodeCoupon), nil)
	if err != nil {
	...
	instrumentLoyaltyPoints, err := DeserializeV1([]byte(CodeLoyaltyPoints), nil)
	if err != nil {
	...
	instrumentTicketAdmission, err := DeserializeV1([]byte(CodeTicketAdmission), nil)
	if err != nil {
	...
	instrumentCasinoChip, err := DeserializeV1([]byte(CodeCasinoChip), nil)
	if err != nil {
	...
	instrumentInformationServiceLicense, err := DeserializeV1([]byte(CodeInformationServiceLicense), nil)
	if err != nil {
