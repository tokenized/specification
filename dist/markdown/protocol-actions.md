...
<table>
    ...
    <tr>
        ...
        <td>
            Set to true if an administration is permitted to make proposals outside of the smart contract scope.
...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            Cannot be changed by administration, operator or smart contract.
        </td>
    </tr>
    <tr>
        <td>AssetIndex</td>
    ...
    <tr>
        ...
        <td>
            ...
            Cannot be changed by administration, operator. Smart contract controls.
        </td>
    </tr>
</table>
...
<table>
   ...
   <tr>
        <td class="text-center">0</td>
        <td>Administrator's Public Address</td>
        <td>The smart contract sets the administration public address with whatever public address is in Index 0 of the first valid Contract Offer.  From then on, the SC will only respond to 'commands' (request actions) from this address with respect to actions that are administration controlled according to the protocol.</td>
    </tr>
   <tr>
...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            Can't be changed by administration or smart contract operator. Example: 0
        </td>
    </tr>
    <tr>
        <td>Timestamp</td>
...
<table>
    ...
    <tr>
        ...
        <td>
            Used to change the administration address.  The new administration address must be in the input[1] position. A change of an administration or operator address requires both the operator and the administration address to be in the inputs (both signatures) of the Contract Amendment action.
             Example: 1
        </td>
    </tr>
    <tr>
...
Allows Administrations/Token Holders to propose a change (aka Initiative/Shareholder vote).  A significant cost - specified in the Contract Formation - can be attached to this action when sent from Token Holders to reduce spam, as the resulting vote will be put to all token owners.
