...
<div class="ritz grid-container" dir="ltr">
    <table class="waffle" cellspacing="0" cellpadding="0" table-layout=fixed width=100%>
        ...
        <tr>
            <td class="t6" colspan="7">
                <a href="javascript:;" data-popover="type-QuantityIndex">
                   Asset 1 Senders - Click to show content
                </a>
            </td>
        </tr>
        ...
        <tr>
            <td class="t6" colspan="7">
                <a href="javascript:;" data-popover="type-TokenReceiver">
                   Asset 1 Receivers - Click to show content
                </a>
            </td>
        </tr>
        ...
        <tr>
            <td class="t6" colspan="7">
                <a href="javascript:;" data-popover="type-QuantityIndex">
                   Asset 2 Senders - Click to show content
                </a>
            </td>
        </tr>
        ...
        <tr>
            <td class="t6" colspan="7">
                <a href="javascript:;" data-popover="type-TokenReceiver">
                   Asset 2 Receivers - Click to show content
                </a>
            </td>
        </tr>
