...
class AssetTransfer {
    ...
    Validate() {
        ...
        {
            if (this.asset_senders.length > (Math.pow(2, 8)) - 1) {
                return sprintf_js_1.sprintf('list field asset_senders has too many items %d/%d', this.asset_senders.length, (Math.pow(2, 8)) - 1);
            }
        ...
        {
            if (this.asset_receivers.length > (Math.pow(2, 8)) - 1) {
                return sprintf_js_1.sprintf('list field asset_receivers has too many items %d/%d', this.asset_receivers.length, (Math.pow(2, 8)) - 1);
            }
