...
exports.GetRejectionCodes = GetRejectionCodes;
function GetRejectionCode(code) {
    const types = GetRejectionCodes();
    return types[code];
}
exports.GetRejectionCode = GetRejectionCode;
...
exports.GetPolityTypes = GetPolityTypes;
function GetPolityType(pol) {
    const types = GetPolityTypes();
    return types[pol];
}
exports.GetPolityType = GetPolityType;
class RoleType {
}
