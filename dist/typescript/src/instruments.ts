...
// InstrumentTypeLen is the size in bytes of all instrument type variants.
const InstrumentTypeLen = 152;
...
// InstrumentPayload is the interface for payloads within instrument actions.
...
// InstrumentTypeMapping holds a mapping of instrument codes to instrument types.
export function InstrumentTypeMapping(code: string): InstrumentPayload {
	switch (code) {
	case CodeCoupon:
		return new Coupon();
	case CodeCurrency:
...
// Coupon instrument type.
export class Coupon implements InstrumentPayload {

// The version number that this instrument payload adheres to.
...
export class Currency implements InstrumentPayload {
...
// LoyaltyPoints instrument type.
export class LoyaltyPoints implements InstrumentPayload {
...
// Membership instrument type.
export class Membership implements InstrumentPayload {
...
// ShareCommon instrument type.
export class ShareCommon implements InstrumentPayload {

// The version number that this instrument payload adheres to.
	version; // uint8 `json:"version,omitempty"`
// A period of time where the instrument is unable to be transferred.  After the transfer lockout period, the instruments can be transferred.
...
// TicketAdmission instrument type.
export class TicketAdmission implements InstrumentPayload {
