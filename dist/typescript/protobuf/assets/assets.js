 ...
 * @constructor
 */
proto.assets.PeriodField = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.assets.PeriodField, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.assets.PeriodField.displayName = 'proto.assets.PeriodField';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.assets.TimeField = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.assets.TimeField, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.assets.TimeField.displayName = 'proto.assets.TimeField';
}
...
proto.assets.BondFixedRate.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    interestpaymentperiod: (f = msg.getInterestpaymentperiod()) && proto.assets.PeriodField.toObject(includeInstance, f),
    latepaymentpenaltyrate: (f = msg.getLatepaymentpenaltyrate()) && proto.assets.RateField.toObject(includeInstance, f),
    latepaymentpenaltyperiod: (f = msg.getLatepaymentpenaltyperiod()) && proto.assets.PeriodField.toObject(includeInstance, f),
    latepaymentwindow: jspb.Message.getFieldWithDefault(msg, 10, 0),
    maturitydate: jspb.Message.getFieldWithDefault(msg, 11, 0),
    agerestriction: (f = msg.getAgerestriction()) && proto.assets.AgeRestrictionField.toObject(includeInstance, f),
    transferspermitted: jspb.Message.getBooleanFieldWithDefault(msg, 13, false)
  };
...
proto.assets.BondFixedRate.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new proto.assets.PeriodField;
      reader.readMessage(value,proto.assets.PeriodField.deserializeBinaryFromReader);
      msg.setInterestpaymentperiod(value);
      break;
    case 8:
      var value = new proto.assets.RateField;
      reader.readMessage(value,proto.assets.RateField.deserializeBinaryFromReader);
...
proto.assets.BondFixedRate.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getInterestpaymentperiod();
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.assets.PeriodField.serializeBinaryToWriter
    );
  }
...
/**
 * optional PeriodField InterestPaymentPeriod = 7;
 * @return {?proto.assets.PeriodField}
 */
proto.assets.BondFixedRate.prototype.getInterestpaymentperiod = function() {
  return /** @type{?proto.assets.PeriodField} */ (
    jspb.Message.getWrapperField(this, proto.assets.PeriodField, 7));
};


/**
 * @param {?proto.assets.PeriodField|undefined} value
 * @return {!proto.assets.BondFixedRate} returns this
*/
proto.assets.BondFixedRate.prototype.setInterestpaymentperiod = function(value) {
 ...
 * @return {!proto.assets.BondFixedRate} returns this
 */
proto.assets.BondFixedRate.prototype.clearInterestpaymentperiod = function() {
  return this.setInterestpaymentperiod(undefined);
};
 ...
 * @return {boolean}
 */
proto.assets.BondFixedRate.prototype.hasInterestpaymentperiod = function() {
  return jspb.Message.getField(this, 7) != null;
};


/**
 * optional RateField LatePaymentPenaltyRate = 8;
 * @return {?proto.assets.RateField}
 */
proto.assets.BondFixedRate.prototype.getLatepaymentpenaltyrate = function() {
  return /** @type{?proto.assets.RateField} */ (
    jspb.Message.getWrapperField(this, proto.assets.RateField, 8));
};
...
/**
 * optional PeriodField LatePaymentPenaltyPeriod = 9;
 * @return {?proto.assets.PeriodField}
 */
proto.assets.BondFixedRate.prototype.getLatepaymentpenaltyperiod = function() {
  return /** @type{?proto.assets.PeriodField} */ (
    jspb.Message.getWrapperField(this, proto.assets.PeriodField, 9));
};
 ...
 * @return {!proto.assets.BondFixedRate} returns this
 */
proto.assets.BondFixedRate.prototype.clearLatepaymentpenaltyperiod = function() {
  return this.setLatepaymentpenaltyperiod(undefined);
};
 ...
 * @return {boolean}
 */
proto.assets.BondFixedRate.prototype.hasLatepaymentpenaltyperiod = function() {
...
/**
 * optional uint64 MaturityDate = 11;
 * @return {number}
 */
...
/**
 * optional AgeRestrictionField AgeRestriction = 12;
 * @return {?proto.assets.AgeRestrictionField}
 */
proto.assets.BondFixedRate.prototype.getAgerestriction = function() {
  return /** @type{?proto.assets.AgeRestrictionField} */ (
    jspb.Message.getWrapperField(this, proto.assets.AgeRestrictionField, 12));
};
...
/**
 * optional bool TransfersPermitted = 13;
 * @return {boolean}
 */
 ...
 * @return {!Object}
 */
proto.assets.PeriodField.prototype.toObject = function(opt_includeInstance) {
  return proto.assets.PeriodField.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.assets.PeriodField} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assets.PeriodField.toObject = function(includeInstance, msg) {
  var f, obj = {
    unit: jspb.Message.getFieldWithDefault(msg, 1, ""),
    unitcount: jspb.Message.getFieldWithDefault(msg, 2, 0),
    endunit: jspb.Message.getFieldWithDefault(msg, 3, 0),
    endindex: jspb.Message.getFieldWithDefault(msg, 4, 0),
    endcount: jspb.Message.getFieldWithDefault(msg, 5, 0),
    endtime: (f = msg.getEndtime()) && proto.assets.TimeField.toObject(includeInstance, f)
  };
 ...
 * @return {!proto.assets.PeriodField}
 */
proto.assets.PeriodField.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.assets.PeriodField;
  return proto.assets.PeriodField.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.assets.PeriodField} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.assets.PeriodField}
 */
proto.assets.PeriodField.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 5:
      var value = /** @type {number} */ (reader.readUint64());
      msg.setEndcount(value);
      break;
    case 6:
      var value = new proto.assets.TimeField;
      reader.readMessage(value,proto.assets.TimeField.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.assets.PeriodField.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.assets.PeriodField.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.assets.PeriodField} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assets.PeriodField.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUnit();
  if (f.length > 0) {
    writer.writeString(
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.assets.TimeField.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {string}
 */
proto.assets.PeriodField.prototype.getUnit = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.assets.PeriodField} returns this
 */
proto.assets.PeriodField.prototype.setUnit = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional uint64 UnitCount = 2;
 * @return {number}
 */
proto.assets.PeriodField.prototype.getUnitcount = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.assets.PeriodField} returns this
 */
proto.assets.PeriodField.prototype.setUnitcount = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};


/**
 * optional uint64 EndUnit = 3;
 * @return {number}
 */
proto.assets.PeriodField.prototype.getEndunit = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.assets.PeriodField} returns this
 */
proto.assets.PeriodField.prototype.setEndunit = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {number}
 */
proto.assets.PeriodField.prototype.getEndindex = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.assets.PeriodField} returns this
 */
proto.assets.PeriodField.prototype.setEndindex = function(value) {
  return jspb.Message.setProto3IntField(this, 4, value);
};


/**
 * optional uint64 EndCount = 5;
 * @return {number}
 */
proto.assets.PeriodField.prototype.getEndcount = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
 ...
 * @return {!proto.assets.PeriodField} returns this
 */
proto.assets.PeriodField.prototype.setEndcount = function(value) {
  return jspb.Message.setProto3IntField(this, 5, value);
};


/**
 * optional TimeField EndTime = 6;
 * @return {?proto.assets.TimeField}
 */
proto.assets.PeriodField.prototype.getEndtime = function() {
  return /** @type{?proto.assets.TimeField} */ (
    jspb.Message.getWrapperField(this, proto.assets.TimeField, 6));
};


/**
 * @param {?proto.assets.TimeField|undefined} value
 * @return {!proto.assets.PeriodField} returns this
*/
proto.assets.PeriodField.prototype.setEndtime = function(value) {
  return jspb.Message.setWrapperField(this, 6, value);
};
 ...
 * @return {!proto.assets.PeriodField} returns this
 */
proto.assets.PeriodField.prototype.clearEndtime = function() {
 ...
 * @return {boolean}
 */
proto.assets.PeriodField.prototype.hasEndtime = function() {
  return jspb.Message.getField(this, 6) != null;
};
 ...
 * @return {!Object}
 */
proto.assets.TimeField.prototype.toObject = function(opt_includeInstance) {
  return proto.assets.TimeField.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.assets.TimeField} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assets.TimeField.toObject = function(includeInstance, msg) {
  var f, obj = {
    time: jspb.Message.getFieldWithDefault(msg, 1, 0),
    timezoneoffset: jspb.Message.getFieldWithDefault(msg, 2, 0),
    timezonepositive: jspb.Message.getBooleanFieldWithDefault(msg, 3, false)
  };
 ...
 * @return {!proto.assets.TimeField}
 */
proto.assets.TimeField.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.assets.TimeField;
  return proto.assets.TimeField.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.assets.TimeField} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.assets.TimeField}
 */
proto.assets.TimeField.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.assets.TimeField.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.assets.TimeField.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.assets.TimeField} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assets.TimeField.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTime();
  if (f !== 0) {
    writer.writeUint64(
 ...
 * @return {number}
 */
proto.assets.TimeField.prototype.getTime = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.assets.TimeField} returns this
 */
proto.assets.TimeField.prototype.setTime = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.assets.TimeField.prototype.getTimezoneoffset = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.assets.TimeField} returns this
 */
proto.assets.TimeField.prototype.setTimezoneoffset = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};


/**
 * optional bool TimeZonePositive = 3;
 * @return {boolean}
 */
proto.assets.TimeField.prototype.getTimezonepositive = function() {
 ...
 * @return {!proto.assets.TimeField} returns this
 */
proto.assets.TimeField.prototype.setTimezonepositive = function(value) {
